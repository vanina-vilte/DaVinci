# Proyecto Grupal de un Sitio Web
...
**Sección Store (Tiendas):**
- Descripción: En esta sección del sitio web se destacan las ofertas y promociones que Da Vinci ofrece tanto en línea como en sus tiendas físicas. Los usuarios pueden visualizar descuentos exclusivos y aprovechar beneficios de compra, como envíos gratuitos y la opción de pagos en cuotas sin interés. Esta área está enfocada en promover las ventas mediante incentivos y facilidad de pago, mejorando así la experiencia del cliente.

--Promociones:--
- Da Vinci OFF Days: Ofrece hasta un 30% de descuento en compras, disponibles tanto online como en tiendas físicas.
Lema promocional: "Pagá menos, llevá más," que incentiva a los usuarios a aprovechar las promociones vigentes.
...
- Productos Destacados: Sección dedicada a mostrar las sudaderas más populares de la tienda, con precios y facilidades de pago claramente indicadas.
  ...
  - Buzo Over H Premium Suede: Precio de $129.990, con opción de 6 cuotas de $21.665 sin interés.
  - Buzo Over H Brown: Precio de $114.990, con opción de 6 cuotas de $19.165 sin interés.
  - Buzo Over Skull: Precio de $74.990, con opción de 6 cuotas de $12.498 sin interés.
  - Buzo Over Cross Black: Precio de $74.990, con opción de 6 cuotas de $12.498 sin interés.

--Funcionalidades:--
- Botones de Compra: Todos los productos incluyen un botón de "Comprar" que permite a los usuarios proceder rápidamente con la compra.
- Suscripción al Newsletter: Los usuarios pueden suscribirse para recibir ofertas y novedades exclusivas, mejorando la comunicación entre la tienda y sus clientes.

**Sección Shop:**
- Descripción: En esta sección del sitio web, los usuarios pueden visualizar una variedad de productos de la marca Da Vinci. En particular, se destacan las sudaderas tipo buzo disponibles en diferentes colores y estilos. Cada producto incluye una imagen de alta calidad, un precio claro y accesible, junto con la opción de realizar el pago en cuotas sin interés. Los clientes pueden navegar fácilmente entre los productos y seleccionar el que mejor se adapte a sus gustos y necesidades.
...
- Información Financiera: Los precios se muestran junto con una opción de pago en cuotas sin interés, lo que mejora la accesibilidad de los productos para una mayor cantidad de usuarios.
- Imágenes Detalladas: Las imágenes de los productos están cuidadosamente seleccionadas para mostrar la calidad y los detalles de cada prenda, ayudando al cliente a tomar decisiones informadas.
...
- Información de contacto: Cada tienda tiene su propio número de teléfono y correo electrónico para que los clientes puedan ponerse en contacto directamente con la tienda correspondiente.
...
- Descripción:La sección de Preguntas Frecuentes está diseñada para resolver las dudas más comunes de los clientes sobre los productos, el proceso de compra, y los envíos. A continuación se presentan algunas de las preguntas más comunes y sus respuestas:

**Contenido:**
- ¿De qué se trata Davinci? Davinci es una tienda sustentable de ropa, ideal para todo tipo de cuerpo.

- ¿Qué formas de pago puedo aprovechar para realizar mi compra? Disponemos de los siguientes medios de pago: Visa, Mastercard, Mercado Pago...

- ¿Cuál es el costo de envío? El costo de envío se mostrará en base al total de la compra y la ubicación, durante el proceso de checkout, antes de confirmar la compra.

- ¿Cómo se realizan los envíos? Trabajamos con las siguientes empresas de envío: Oca correo, Correo Argentino y Andreani.

- ¿Dónde puedo recibir mi pedido? Realizamos envíos a todo el país.

- ¿Cuánto tarda en llegar el pedido? El tiempo de entrega dependerá del tipo de envío seleccionado. En general, la demora es de entre 3 y 7 días hábiles luego de que se acredite el pago.

- ¿Cuál es el plazo para realizar un cambio? Puedes solicitar un cambio hasta 30 días después de realizada la compra.

- ¿Qué debo hacer si el producto no llega en buen estado? Si el producto no llega en buen estado, ponte en contacto con nosotros a través del correo electrónico davincitienda@davinci.com para informarnos el problema y recibir asistencia.
